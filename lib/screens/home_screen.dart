...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  Future<void> _silentRefreshCurrent() async {
    ...
    // De widget moet de ACTUELE positie reflecteren, niet de laatst-opgeslagen.
    // getCurrentLocation() gebruikt network-first (snel, ~5s), dus dit is
    // licht genoeg om elke refresh-tick te draaien.
